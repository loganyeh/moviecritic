...
function ProfileBanner(){
    ...
    return(
        <>
            <div className="flex justify-center bg-gray-300 bg-cover" style={{ backgroundImage: `url(https://i.pinimg.com/736x/fa/b3/05/fab305846142b6c1ffe9ed57f0adb184.jpg)`}}>
