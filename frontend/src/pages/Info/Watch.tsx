            ...
            <section className="flex flex-col gap-3">
                ...
                <div className="flex gap-[32px] overflow-x-scroll">
                    {watch.map((watch, index) => {
                        return <div key={index} className="relative flex justify-between items-end p-5 w-44 md:w-24 lg:w-44 xl:w-44 aspect-video md:aspect-square lg:aspect-video shrink-0 bg-red-300 rounded shadow">
