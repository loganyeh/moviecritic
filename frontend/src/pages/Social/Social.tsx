...
function Social(){
    const socialList = ["Following", "Followers", "Forum Threads", "Forum Comments"];
            ...
            <div className="flex justify-center bg-gray-200">
                <div className="flex flex-col md:flex-row gap-[32px] md:px-[32px] xl:px-0 md:pt-10 md:pb-28 w-full max-w-5xl 2xl:max-w-7xl">
                    ...
                    <div className="flex gap-6 flex-col p-6 md:p-0 w-full md:max-w-[175px]">
                        <Lists title="Social" categories={socialList} />
                    </div>

                    {/* Right Side */}
                    <div className="flex flex-1 justify-center items-center">
                        <p className="pt-12 pb-96 text-xl text-gray-500">Following 0 users ｡ﾟヽ(ﾟ´Д｀)ﾉﾟ｡</p>
                    </div>
                </div>
            </div>
